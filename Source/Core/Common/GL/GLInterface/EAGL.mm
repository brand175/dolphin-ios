// Copyright 2019 Dolphin Emulator Project, OatmealDome
...
bool GLContextEAGL::Initialize(const WindowSystemInfo& wsi, bool stereo, bool core)
{
  ...
  m_backbuffer_width = 1300;
  m_backbuffer_height = 1300;
...
GLuint GLContextEAGL::GetDefaultFramebuffer()
{
  ...
  {
    ERROR_LOG_FMT(VIDEO, "EAGL framebuffer not complete: {n/}0x%x", status);
  }
